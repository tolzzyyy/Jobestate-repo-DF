  ...
  return (
    <div className='mt-20 md:mt-32 w-full py-7 px-[20px] md:px-[50px] lg:px-[135px]'>
      <div className='flex justify-between w-full items-center bg-white'>
        <h1 className='text-5xl font-semibold'>View All Jobs</h1>
        ...
        <div className='w-full lg:w-5/12'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6 lg:max-h-[410px] lg:overflow-y-auto lg:pr-4'>
            {jobs.map((job) => (
              <div 
                key={job.id} 
                className='h-auto border-[#686868] border-[1px] w-full p-6 flex flex-col gap-10 rounded-md  bg-white'
              >
          ...
          <div>
            {job && (
              <div className='h-auto w-full p-6 flex flex-col gap-10 bg-white rounded-t-[30px]  border-[#686868] border-b-[1px]  sticky top-0 z-0'>
                ...
                <div className='w-full h-auto flex justify-between'>
                  <p>{job.location}</p>
                  <a href={job.link} className='underline text-blue-500'>Apply</a>
                </div>
              </div>
            )}
            <p className='p-5  leading-8 text-gray-500'>
              $63,000 + VIP Bonus

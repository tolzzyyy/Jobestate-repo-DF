...
const Home = () => {
  return (
    <div className="overflow-hidden ">
      <section
        style={bgImage}
        className="flex flex-col gap-5  h-[70vh] items-center md:flex md:h-[700px] mx-auto md:items-center xl:flex xl:items-center xl:h-[900px] px-[20px] justify-center"
      >
        ...
        <div className="flex py-2 px-3 border-2 border-gray-100   md:flex md:py-5 md:px-7 md:w-full xl:flex items-center justify-between bg-white xl:shadow-xl shadow-[#a8a8a8] rounded-full xl:w-full xl:py-6 xl:px-10 w-full mx-auto">

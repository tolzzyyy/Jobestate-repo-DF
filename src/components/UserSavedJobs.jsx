...
const UserSavedJobs = () => {
  ...
  return (
    <div className='bg-[#EEF0F2] w-full h-screen lg:h-[1000px] lg:ml-72 '>
      ...
      {show ? <div className='lg:hidden overflow-auto flex flex-col absolute top-16 md:top-16 left-0 gap-[40px] py-7 md:py-10 px-7 md:px-14 bg-white w-full h-screen md:h-screen transition-all duration-500 font-medium text-[15px] md:text-[20px] text-[#2b2b2b] '>

...
const candidates = [
  { name: "John Doe", role: "Software Engineer", appliedFor: "Frontend Developer", email: "johndoe@gmail.com" },
  { name: "Jane Smith", role: "Data Analyst", appliedFor: "Business Analyst", email: "janedoe@gmail.com" },
  { name: "John Doe", role: "Software Engineer", appliedFor: "Frontend Developer", email: "johndoe@gmail.com" },
  { name: "Jane Smith", role: "Data Analyst", appliedFor: "Business Analyst", email: "janedoe@gmail.com" },
  { name: "John Doe", role: "Software Engineer", appliedFor: "Frontend Developer", email: "johndoe@gmail.com" },
  { name: "Jane Smith", role: "Data Analyst", appliedFor: "Business Analyst", email: "janedoe@gmail.com" },
  ...
  return (
    <div className='mt-20 md:mt-32 w-full py-7 px-[20px] md:px-[50px] lg:px-[135px]'>
      <div className='flex justify-between w-full items-center bg-white'>
        <h1 className='text-5xl font-semibold'>View All Applications</h1>
        ...
        <table className="table-auto w-full border-collapse border border-gray-300">
          <thead className="bg-white">
            <tr>
              ...
              <th className="border border-gray-300 px-4 py-4 text-left">Accept</th>
              <th className="border border-gray-300 px-4 py-4 text-left">Decline</th>
            </tr>
          </thead>
          <tbody>

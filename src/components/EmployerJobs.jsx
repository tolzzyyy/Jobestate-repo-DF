    ...
    <div className='py-10 lg:px-36 md:px-14 px-6 mt-20 lg:mt-32 w-full h-full'>
            ...
            <div className=" w-full h-auto items-center gap-y-6 lg:items-start md:grid-cols-2 lg:grid-cols-4 md:gap-x-20 md:gap-y-10  lg:gap-x-8 lg:gap-y-6">
              {jobs.length === 0 ? (
                ...
                <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-4 w-full h-auto'>
           {jobs.map((job) => (
               <div
                 key={job.id}
               ...
               >
                 ...
                 <div className="flex justify-between items-center px-4">
                   ...
                   <Link className="px-2 py-2 md:border-2 border-[#013A8A] md:text-[12px] md:px-6 md:py-3 md:rounded-full text-[#013A8A] font-semibold xl:hover:text-white xl:hover:border-2 xl:hover:border-[#0149AD] xl:hover:bg-[#0149AD] xl:transition-all xl:duration-200">
                     Edit
                   </Link>
                 </div>
               </div>
